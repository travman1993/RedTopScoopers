...
export async function POST(request) {
  ...
  // Always return 200 so Stripe doesn't retry on handler errors
  try {
    switch (event.type) {
      ...
      case 'checkout.session.completed': {
        ...
        // Send welcome billing email only if Resend is configured and customer has email
    ...
    // Log but still return 200 — Stripe should not retry on application errors
